...
use super::MlDsa44Ed25519PublicKey;
...
impl KeyData {
    ...
    /// Get MLDSA44-Ed25519 public key if this key is the correct type.
    #[cfg(feature = "mldsa-eddsa")]
    #[must_use]
    pub fn mldsa44_ed25519(&self) -> Option<&MlDsa44Ed25519PublicKey> {
        match self {
    ...
    pub fn decode_as(reader: &mut impl Reader, algorithm: Algorithm) -> Result<Self> {
        match algorithm {
            ...
            Algorithm::MlDsa44Ed25519 => {
                MlDsa44Ed25519PublicKey::decode(reader).map(Self::MlDsa44Ed25519)
            }
            #[cfg(feature = "ecdsa")]
