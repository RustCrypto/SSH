...
use super::MlDsa44Ed25519Keypair;
...
impl KeypairData {
    ...
    pub fn algorithm(&self) -> Result<Algorithm> {
        Ok(match self {
            ...
            #[cfg(feature = "mldsa-eddsa")]
            Self::MlDsa44Ed25519(key) => key.algorithm(),
            #[cfg(all(feature = "alloc", feature = "ecdsa"))]
    ...
    /// Get MLDSA44-Ed25519 keypair if this key is the correct type.
    #[cfg(feature = "mldsa-eddsa")]
    #[must_use]
    pub fn mldsa44_ed25519(&self) -> Option<&MlDsa44Ed25519Keypair> {
        match self {
    ...
    /// Is this key an ML-DSA-44-Ed25519 composite key?
    #[cfg(feature = "mldsa-eddsa")]
    #[must_use]
    ...
    pub(super) fn checkint(&self) -> u32 {
        let bytes = match self {
            ...
            #[cfg(feature = "mldsa-eddsa")]
            Self::MlDsa44Ed25519(mldsa) => mldsa.private.checkint_bytes(),
            #[cfg(all(feature = "alloc", feature = "ecdsa"))]
...
impl TryFrom<&KeypairData> for public::KeyData {
    ...
    fn try_from(keypair_data: &KeypairData) -> Result<public::KeyData> {
        Ok(match keypair_data {
            ...
            #[cfg(feature = "mldsa-eddsa")]
            KeypairData::MlDsa44Ed25519(mldsa) => public::KeyData::MlDsa44Ed25519(mldsa.into()),
            #[cfg(all(feature = "alloc", feature = "ecdsa"))]
