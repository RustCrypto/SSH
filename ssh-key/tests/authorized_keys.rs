...
fn read_example_file() {
    ...
    assert_eq!(
        authorized_keys[1].public_key().to_string(),
    ...
    assert_eq!(
        authorized_keys[2].public_key().to_string(),
    ...
    assert_eq!(
        authorized_keys[3].public_key().to_string(),
    ...
    assert_eq!(
        authorized_keys[4].public_key().to_string(),
